...
{
    public class IFileAppStorageService : IFileStorageService
    {
        private readonly IWebHostEnvironment env;
        private readonly IHttpContextAccessor httpContextAccessor;

        public IFileAppStorageService(IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor)
        {
            this.env = env;
        ...
        public async Task<string> SaveFile(string containerName, IFormFile file)
        {
            ...
            var routeForDB = Path.Combine(url, containerName, fileName).Replace("//", "/").Replace(@"\","/");
            return routeForDB;
